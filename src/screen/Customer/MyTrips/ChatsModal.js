    ...
    try {
      const responseOne = await axios.get(
        `https://testing.explorelogix.com/v1/chat/conversation?member=${selectedUserId}`,
        {
          headers: {
            authorization:
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..vj9OT3Y20gBE4fvtY0pxtZqHNPbj2q4NuCOX-wD989E",
          },
        }
      );
