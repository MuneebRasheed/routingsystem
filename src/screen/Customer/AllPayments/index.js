  ...
  render() {
    return <Container style={theme.layout}>
      ...
      <View style={styles.notificationHeader}>
        <View>
        <Text style={styles.notificationHeaderTitle}>{__('PAYMENTS')}</Text>
        <Text style={styles.notificationHeaderText}>{__('MANAGE YOUR PAYMENTS')}</Text>
        </View>
        <View><Button style={styles.yesBtn} onPress={()=>{navigate("CustomerPayment")}} >
            <Text style={styles.yesBtnText}>{__('ADD ACCOUNT')}</Text>
          </Button></View>
      </View>
