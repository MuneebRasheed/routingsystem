    ...
    return (
      <Container>
              ...
              <View style={styles.sharedVehicleContent2}>
                ...
                <View style={styles.vehicleItem}>
                  <Text style={styles.vehicleItemText}>
                    {__("7.2 ft X 4/2 Ft X 1 Ft")}
                  </Text>
                  <Text style={styles.vehicleItemText}>{__("20 Nos")}</Text>
                </View>
                <View style={styles.vehicleItem}>
                  <Text style={styles.vehicleItemText}>
                    {__("4.2 ft X 2/1 Ft X 1 Ft")}
                  </Text>
                ...
                <Accordion
                  ...
                  renderContent={() => (
                    <View style={styles.accOrderInfo}>
                      ...
                      <Button>
                        <Text style={styles.accText}>
                          {__("Concrete transport truck (cement mixer)")}
                        </Text>
                      </Button>
                    </View>
                  )}
        ...
        >
          <View>
            <Image
              source={require("@asset/images/package.png")}
          ...
          <View style={styles.mPackageInfo}>
            <Text style={styles.mPackageTitle}>
              {__("7.2 ft x 4/2 ft x 1ft")}
            </Text>
            <Text style={styles.mPackageText}>{__("20 Nos")}</Text>
          </View>
          <View style={styles.mPackageInfo}>
            <Text style={styles.mPackageTitle}>
              {__("41 ft x 4/2 ft x 2ft")}
            </Text>
        ...
        >
          <Text style={styles.bookingBtnText}>{__("BOOK NOW")} jhjhg</Text>
        </Button>
      </Container>
    );
  }
