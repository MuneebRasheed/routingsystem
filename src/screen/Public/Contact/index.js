  ...
  async onSubmit() {
    ...
    try {
      ...
      await Support.showSuccess({
        ...
        message: __('Your comments can be sent successfully'),
        onHide: () => {
          navigateReset('')
        },
        hideDelay: 2500
  ...
  render() {
    return <Container>
      ...
      <View style={styles.contactHeader}>
        ...
        <Text style={styles.contactHeaderText}>{__('Information about your company')}</Text>
      </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.contactContainer}>
            ...
            <Button style={styles.sendBtn} onPress={this.onSubmit}>
              <Text style={styles.sendText}>{__('SEND')}</Text>
            </Button>
          </View>
        </ScrollView>
      </Content>
